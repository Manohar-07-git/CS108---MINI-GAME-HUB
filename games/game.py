...
######################################################################################################################################################################################
#Made an grid of rectangles for locating each square of the game board  
while True:
...
######################################################################################################################################################################################################
                while True:
                    ...
                    if winner==1 or winner==2 or not np.any(player.board==0):
                        return_surf=pygame.image.load('media/returnmenu.png').convert()
                        return_surf=pygame.transform.scale(return_surf,(200,40))
                        ...
                        return_rect=return_surf.get_rect(topleft=(400,600))
                        screen.blit(wins_surf,wins_rect)
                        screen.blit(loses_surf,losses_rect)
                        ...
                        if wins_rect.collidepoint(mouse_pos):
                            pygame.quit()
                            subprocess.run("python3 leaderboard.sh wins",shell=True)
                            subprocess.run("python3","plot.py")
                            exit()
                        if losses_rect.collidepoint(mouse_pos):
                            pygame.quit()
                            subprocess.run("python3 leaderboard.sh losses",shell=True)
                            subprocess.run("python3","plot.py")
                            exit()
                        if ratio_rect.collidepoint(mouse_pos):
                            pygame.quit()
                            subprocess.run("python3 leaderboard.sh ratio",shell=True)
                            subprocess.run("python3","plot.py")
                            exit()
                        if return_rect.collidepoint(mouse_pos):
                            pygame.quit()
                            subprocess.run(f"python3 game.py {p1} {p2}",shell=True)
...
############################################# OTHELLO #######################################################################################################################################################
            if oth_rect.collidepoint(mouse_pos): 
                ...
                empty_surf=pygame.image.load('./media/emptyoth.png').convert()
                empty_surf=pygame.transform.scale(empty_surf,(80,80))
                ...
                n_surf=pygame.image.load('./media/emptyoth.png')
...
###################################################################################################################################################################################################################################################################
                while True:
                    ...
                    if winner==1 or winner==2 or not np.any(player.board==0):
                        ...
                        ratio_surf=pygame.image.load('media/ratio.png').convert()
                        ratio_surf=pygame.transform.scale(ratio_surf,(200,40))
                        wins_rect=img_surf.get_rect(topleft=(125,500))
                        losses_rect=img_surf.get_rect(topleft=(425,500))
                        ratio_rect=img_surf.get_rect(topleft=(725,500))
                        return_rect=img_surf.get_rect(topleft=(400,600))
                        screen.blit(wins_surf,wins_rect)
                        screen.blit(loses_surf,losses_rect)
                        screen.blit(ratio_surf,ratio_rect)
                        screen.blit(return_surf,return_rect)
